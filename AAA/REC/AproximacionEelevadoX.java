...
public class AproximacionEelevadoX {
    ...
    public static int factLam(int numero){
     ...
     public static void main(String[] args){
         System.out.println("Aprox e^x Iterativo " + aproxIt(5, 10));
         System.out.println("Aprox e^x Recursivo " + aproxRec(5, 10));
         System.out.println("Aprox e^x lambda " + aproxlam(5, 10));
     }
